...
var TimeTable = React.createClass({
    ...
    getTimeLine: function(time) {
        ...
        return minutes ? <TimeLine height={minutes * 2 - 2 + "px"} description="hoge" /> : null;
    },
    render: function() {
    ...
    render: function() {
        return (
            <div className="Page container">
                <input type="range" min="15" max="120" step="15" value={this.state.value} onChange={this.onChange}/>
